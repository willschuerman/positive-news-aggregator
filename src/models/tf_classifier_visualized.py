...
maxlength = max([len(x) for x in training_sequences])

training_padded = pad_sequences(
    training_sequences, maxlen=maxlength, padding='post', truncating='post')
testing_sequences = tokenizer.texts_to_sequences(testing_text)
testing_padded = pad_sequences(
    testing_sequences, maxlen=maxlength, padding='post', truncating='post')
...
plt.imshow(training_padded,vmin=0,vmax=200,aspect='auto')
plt.tight_layout()
plt.show()
...
padded_seqs = pad_sequences(sequences, maxlen=maxlength,
